...
control process_tunnel_encap(inout my_headers_t hdr,
  ...
  @name(".ipv4_ip_rewrite") action ipv4_ip_rewrite(){
      hdr.inner_ipv4.srcAddr = meta.src_ipv4;
      hdr.inner_ipv4.dstAddr = meta.dst_ipv4;
      hdr.inner_ipv4.protocol = 8w06;
	      /* set ip outer*/
  }

  @name(".tunnel_encap_process_outer1") table tunnel_encap_process_outer1{
      actions = {
          nop;
          ipv4_ip_rewrite;
      }
  ...
  apply {
     ...
     tunnel_encap_process_outer1.apply();
  }
