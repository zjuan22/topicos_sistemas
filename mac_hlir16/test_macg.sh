...
./src/hardware_dep/shared/ctrl_plane/mac_l3_controller_juan &
#./src/hardware_dep/shared/ctrl_plane/ant_l3 &
...
python src/transpiler.py $TS/bng_files/bng_elte.p4 --p4v 16
#python src/transpiler.py examples/p4_16/l2_fwd_16.p4 --p4v 16
#python src/transpiler.py examples/p4_src/l2_l3.p4
#python src/transpiler.py examples/p4_16/l3_routing_test_16.p4 --p4v 16
#python src/transpiler.py examples/p4_16/l3_routing_test_16.p4
