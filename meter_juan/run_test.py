...
parser.add_argument('--greh1',
		...
		action="store_true",
		default=False)
parser.add_argument('--eth1',
		help='Inf set ethernet pkts are send through veth1 to veth2',
		action="store_true",
		default=False)
...
if args.h2h1:
    ...
    pkt = Ether(dst='aa:1b:eb:df:44:3d',src='00:44:00:00:00:00')/"Ethernet packet"
    port2send = port_map[1]
else:
