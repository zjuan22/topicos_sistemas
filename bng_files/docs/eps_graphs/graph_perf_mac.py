...
#                                                                       
#v6_pps_dpdk_64 =    [ 14.8893573, 14.8878317, 14.8874925,14.894,     9.787 ]
...
#v6_pps_netmap_128 = [  8.4416536,  8.1401565,  7.0519913, 6.5671111, 5.4320285 ]  
...
ax.bar(xtick+0.34, dpdk_64 , 0.34,     color="gray",edgecolor="black", **next(styles))
ax.set_ylabel('Gbps')
...
ax2.bar(xtick+0.35,dpdk_128   , 0.35, color="gray",   edgecolor="black", **next(styles))
...
ax3.bar(xtick+0.35,dpdk_256   , 0.35,  color="gray",   edgecolor="black", **next(styles))
...
ax4.bar(xtick+0.35,v6_dpdk_64   , 0.35, color="gray",   edgecolor="black", **next(styles))                
...
ax5.bar(xtick+0.35,v6_dpdk_128   , 0.35,  color="gray",   edgecolor="black", **next(styles))                
...
ax6.bar(xtick+0.35,v6_dpdk_256   , 0.35, color="gray",   edgecolor="black", **next(styles))                
