...
if args.h2h1:
    ...
    pkt = Ether(dst='aa:1b:eb:df:44:3d',src='00:44:00:00:00:00')/IP(dst='10.0.0.10',src='10.0.0.10')/GRE()/IP(dst='4.0.0.1',src='4.0.0.10')/TCP(sport=81, dport=1025)/"GRE packet"
